...
# specificity_cart = compute_macro_specificity(y_test, y_pred_cart)
# print(f"CART: F1 = {f1:.4f}, Recall = {recall:.4f}, Specificty = {specificity_cart:.4f}")
...
# c45 = DecisionTreeClassifier(criterion='entropy', random_state=42, max_depth=4)
...
# specificity_c45 = compute_macro_specificity(y_test, y_pred_c45)
# print(f"C4.5: F1 = {f1_c45:.4f}, Recall = {recall_c45:.4f}, Specificty = {specificity_c45:.4f}")
